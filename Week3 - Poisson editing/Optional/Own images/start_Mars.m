clearvars;
dst = double(imread('Mars.jpg'));
src = double(imread('city.jpg')); % flipped girl, because of the eyes
...
mask_src=imread('mask2_before.jpg');
...
mask_dst = padarray(mask_src, [256,620], 0, 'pre');
mask_dst = padarray(mask_dst, [243,0], 0, 'post');
...
for nC = 1: nChannels
    ...
    param.driving = 1.2.*driving_on_dst;
